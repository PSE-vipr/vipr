...
/**
 * Dieser Listener ermöglicht die Berechnung einer Anfrage bis es keine weiteren
 * Lösungen mehr gibt.
 */
public class ButtonAllSolutionsListener implements ActionListener {
     ...
     */
    public ButtonAllSolutionsListener(Interpreter ip, CodeEditor ce, GraphicPane gp, ToolBar tb, InOut io,
    ...
    /**
     * Startet die Berechnung einer Anfrage. Stoppt wenn es keine weiteren Lösungen
     * gibt.
     */
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        graphicPane.reset();
        Calculation calculation = new Calculation(CalculationType.ALL_SOLUTIONS, interpreter, codeEditor, graphicPane,
