...
/**
 * Dieser Listener ermöglicht die Berechnung des nächsten Schrittes einer
 * Anfrage.
 */
public class ButtonNextStepListener implements ActionListener {
     ...
     */
    public ButtonNextStepListener(Interpreter ip, CodeEditor ce, GraphicPane gp, ToolBar tb, InOut io, Memento memento,
            GUIMain guiMain) {
    ...
    /**
     * Startet die Berechnung einer Anfrage. Stoppt nach dem nächsten
     * Berechnungsschritt.
     */
    @Override
    public void actionPerformed(ActionEvent e) {
        // Knöpfe aktivieren / deaktivieren
        toolBar.buttonsWhileNext();
        this.graphicPane.reset();
        Calculation calculation = new Calculation(CalculationType.NEXT_STEP, interpreter, codeEditor, graphicPane,
